...
//Name: mugen.20180805.0013.ma
//Last modified: Sun, Aug 05, 2018 12:16:28 AM
//Codeset: 932
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 982.02025403777111 -1385.3597641997505 317.28860213397047 ;
	setAttr ".r" -type "double3" 174.69133200854716 165.89245769714614 179.99999999997979 ;
	setAttr ".rp" -type "double3" -2.6645352591003757e-015 0 -5.6843418860808015e-014 ;
	setAttr ".rpt" -type "double3" -739.59053602394044 1537.7693060534045 617.81535141495942 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "7355F07A-481A-0C45-64CF-7AAF6F649C1F";
	setAttr -k off ".v" no;
	setAttr ".fl" 150;
	setAttr ".coi" 942.08840139495624;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0 5.7300538889371921 -6.8555340766906738 ;
...
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.56505560874938965 0.7514946460723877 ;
	...
	setAttr -s 112 ".pt";
	setAttr ".pt[28]" -type "float3" 0.58773404 0 0.12540512 ;
	setAttr ".pt[30]" -type "float3" 0.19804123 -0.0081821056 0.19856888 ;
	setAttr ".pt[31]" -type "float3" -0.092736945 -0.27042049 0 ;
	setAttr ".pt[49]" -type "float3" 0.55278742 0.035770316 0 ;
	setAttr ".pt[52]" -type "float3" 0.15802683 -0.019137012 0.081718661 ;
	setAttr ".pt[67]" -type "float3" 0.23387842 0 0.10976185 ;
	setAttr ".pt[71]" -type "float3" 0 -0.06039289 0.32121938 ;
	setAttr ".pt[240]" -type "float3" 0.82888079 -0.25255215 0 ;
	setAttr ".pt[241]" -type "float3" 0 0.12787835 0.60335749 ;
	setAttr ".pt[242]" -type "float3" -0.1689053 -0.1925275 -0.05753357 ;
	setAttr ".pt[243]" -type "float3" -0.49832302 -1.3699737 0 ;
	setAttr ".pt[244]" -type "float3" -0.43877631 -0.14604242 0.4704302 ;
	setAttr ".pt[245]" -type "float3" 0 0.066846058 0.35121766 ;
	setAttr ".pt[246]" -type "float3" -0.047886387 0.068925232 0 ;
	setAttr ".pt[247]" -type "float3" 0 -0.5602541 0.015524759 ;
	setAttr ".pt[264]" -type "float3" 1.1169903 -1.9569108 -0.86347771 ;
	setAttr ".pt[266]" -type "float3" -1.636534 -1.5249248 -0.84916389 ;
	setAttr ".pt[270]" -type "float3" 1.1285031 -1.4210855e-014 0.97236007 ;
	setAttr ".pt[272]" -type "float3" -0.0578347 -0.3523441 0 ;
	setAttr ".pt[273]" -type "float3" 0.054586317 -0.028873403 0.50099611 ;
	setAttr ".pt[274]" -type "float3" 0 -0.20620975 0.73372722 ;
	setAttr ".pt[275]" -type "float3" 0 -0.028316738 0.25958091 ;
	setAttr ".pt[276]" -type "float3" -0.60940593 -0.54328465 -0.20755039 ;
	setAttr ".pt[277]" -type "float3" 0.40522164 -0.20684864 -0.097380683 ;
	setAttr ".pt[279]" -type "float3" 0.43051043 -0.20489596 0.10503922 ;
	setAttr ".pt[309]" -type "float3" 0.30831444 0 -0.0072017862 ;
	setAttr ".pt[310]" -type "float3" 0 -0.033603474 0.32478195 ;
	setAttr ".pt[311]" -type "float3" 0.61616194 1.4210855e-014 0.042484432 ;
	setAttr ".pt[312]" -type "float3" 0.62009001 7.1054274e-015 0.054105796 ;
	setAttr ".pt[313]" -type "float3" 0.66226178 0 -0.026197122 ;
	setAttr ".pt[315]" -type "float3" -0.19175152 0 0.074505053 ;
	setAttr ".pt[316]" -type "float3" 0 -0.071649767 0.34833562 ;
	setAttr ".pt[317]" -type "float3" 0 -0.20620975 0.73372722 ;
	setAttr ".pt[318]" -type "float3" 0 0.16139007 0.48295277 ;
	setAttr ".pt[319]" -type "float3" 0.24093316 -0.18426876 0.73372722 ;
	setAttr ".pt[320]" -type "float3" 0 -0.0045834533 0.39950487 ;
	setAttr ".pt[321]" -type "float3" 0 -0.071649767 0.34833562 ;
	setAttr ".pt[322]" -type "float3" -0.42589754 -0.18801443 0.34833562 ;
	setAttr ".pt[323]" -type "float3" 0 -0.086505152 0.31396487 ;
	setAttr ".pt[325]" -type "float3" -0.0020165704 0 -0.57893693 ;
	setAttr ".pt[327]" -type "float3" 0 0.0085703796 -0.26671347 ;
	setAttr ".pt[328]" -type "float3" -0.78887707 -0.69714987 -1.2990279 ;
	setAttr ".pt[329]" -type "float3" -0.25530881 0 -0.32312912 ;
	setAttr ".pt[330]" -type "float3" 1.0587337 -1.0905219 -0.81339359 ;
	setAttr ".pt[331]" -type "float3" -0.025762293 0 -0.81700617 ;
	setAttr ".pt[332]" -type "float3" 0.4061209 0 -0.17129858 ;
	setAttr ".pt[333]" -type "float3" 0 -0.12951708 -1.1991624 ;
	setAttr ".pt[346]" -type "float3" 0.34446776 0 0.12392658 ;
	setAttr ".pt[347]" -type "float3" -0.24689671 -0.54328465 0.14346184 ;
	setAttr ".pt[348]" -type "float3" 0.041065589 -0.9630354 0 ;
	setAttr ".pt[352]" -type "float3" -0.31428018 0 -0.79758787 ;
	setAttr ".pt[353]" -type "float3" 0.098591238 -1.0935439 -0.26336509 ;
	setAttr ".pt[354]" -type "float3" 0.20679028 -0.48052257 0.11142406 ;
	setAttr ".pt[355]" -type "float3" 0.35194662 -0.00046167785 0.10544521 ;
	setAttr ".pt[369]" -type "float3" 0.48077461 0.11252888 0.14374362 ;
	setAttr ".pt[370]" -type "float3" -0.098670073 -0.54328465 0.074702963 ;
	setAttr ".pt[371]" -type "float3" -0.12496416 -1.7529316 0.12634648 ;
	setAttr ".pt[372]" -type "float3" 0.25035042 -1.4210855e-014 -0.10730152 ;
	setAttr ".pt[384]" -type "float3" 0.14750895 0 -0.96884149 ;
	setAttr ".pt[386]" -type "float3" -0.23978606 -7.1054274e-015 -0.023190076 ;
	setAttr ".pt[387]" -type "float3" 0.12409972 0 0.15994513 ;
	setAttr ".pt[388]" -type "float3" -7.1054274e-015 -0.047582254 -0.29677609 ;
	setAttr ".pt[395]" -type "float3" -0.23787513 -0.59216315 0.54896313 ;
	setAttr ".pt[396]" -type "float3" -0.01748853 0 0.027417216 ;
	setAttr ".pt[410]" -type "float3" 0.2605727 0 -0.18740143 ;
	setAttr ".pt[411]" -type "float3" 0.11738999 0 0.26554263 ;
	setAttr ".pt[574]" -type "float3" 0 -0.080072984 -0.15470447 ;
	setAttr ".pt[579]" -type "float3" -0.080576353 0.15955694 0.41481739 ;
	setAttr ".pt[580]" -type "float3" 0.31188267 0 0 ;
	setAttr ".pt[581]" -type "float3" 0.31188267 0 0 ;
	setAttr ".pt[582]" -type "float3" 0.31188267 0 0 ;
	setAttr ".pt[584]" -type "float3" 0.15961714 0 0.015106173 ;
	setAttr ".pt[585]" -type "float3" 0 0 0.18418071 ;
	setAttr ".pt[587]" -type "float3" 0.27061734 0 0 ;
	setAttr ".pt[588]" -type "float3" 0.63895369 0 0 ;
	setAttr ".pt[589]" -type "float3" 0.63895369 0 0 ;
	setAttr ".pt[590]" -type "float3" 0.63895369 0 0 ;
	setAttr ".pt[591]" -type "float3" 0.47271979 0 -0.041460533 ;
	setAttr ".pt[592]" -type "float3" 0.2236608 0 -0.040818043 ;
	setAttr ".pt[593]" -type "float3" 0.098484553 0 0.23055349 ;
	setAttr ".pt[594]" -type "float3" 0 0.12863982 0.12838791 ;
	setAttr ".pt[595]" -type "float3" 0 0 0.071230933 ;
	setAttr ".pt[599]" -type "float3" 0.1049744 0 0 ;
	setAttr ".pt[600]" -type "float3" -7.1054274e-015 0.056072019 -0.16146213 ;
	setAttr ".pt[605]" -type "float3" 0.13430031 0 0 ;
	setAttr ".pt[606]" -type "float3" 0.23497488 0 0 ;
	setAttr ".pt[607]" -type "float3" 0.23497488 0 0 ;
	setAttr ".pt[608]" -type "float3" 0.23497488 0 0 ;
	setAttr ".pt[609]" -type "float3" 0.13430031 0 0 ;
	setAttr ".pt[610]" -type "float3" 0.18249379 -2.8421709e-014 0.10701334 ;
	setAttr ".pt[611]" -type "float3" -0.076625399 -0.050541215 0.77375007 ;
	setAttr ".pt[612]" -type "float3" 0.40941298 -0.05806078 0 ;
	setAttr ".pt[613]" -type "float3" 0.40941298 -0.05806078 0 ;
	setAttr ".pt[614]" -type "float3" 0.51076216 0.0092876628 0 ;
	setAttr ".pt[615]" -type "float3" 0.24684362 0.057280727 0 ;
	setAttr ".pt[616]" -type "float3" 0.13969962 -0.18768632 -0.12388126 ;
	setAttr ".pt[617]" -type "float3" 0 7.3532228e-006 0.32461834 ;
	setAttr ".pt[618]" -type "float3" -0.089842223 0 -0.028351597 ;
	setAttr ".pt[619]" -type "float3" 0.035669178 0 -0.015343037 ;
	setAttr ".pt[620]" -type "float3" 0.51582962 0 0.0037992522 ;
	setAttr ".pt[621]" -type "float3" 0.73780733 0 0 ;
	setAttr ".pt[622]" -type "float3" 0.56814069 0 0 ;
	setAttr ".pt[623]" -type "float3" 0.66594654 0 0.1511451 ;
	setAttr ".pt[624]" -type "float3" 0.48536578 0 0.35349259 ;
	setAttr ".pt[625]" -type "float3" 0.12402409 0.19762553 0.11176302 ;
	setAttr ".pt[626]" -type "float3" -0.23794129 0.059944391 0.29107374 ;
	setAttr ".pt[651]" -type "float3" 0.3542808 0.017094964 -0.2277882 ;
	setAttr ".pt[652]" -type "float3" 0.17020603 -0.14914685 -0.54945785 ;
	setAttr ".pt[653]" -type "float3" 0.47097158 -0.15005639 -0.35906497 ;
	setAttr ".pt[654]" -type "float3" -0.018652448 -0.59843057 -0.50849283 ;
	setAttr ".pt[655]" -type "float3" 0.23856348 -0.28369737 -0.48678085 ;
	setAttr ".pt[656]" -type "float3" 0.081423998 0 -0.41063362 ;
	setAttr ".dr" 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C0E1B403-4717-9198-3EB5-07BB815800AF";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CC7E37C8-4401-289D-0B26-E89B49683B9D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EC35CC95-4A81-2561-0989-1F9662771214";
createNode displayLayerManager -n "layerManager";
	rename -uid "2303F335-4193-A233-311E-2399E91F808A";
	setAttr ".cdl" 1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2DD74561-4E24-0396-2A2E-2291F31288E9";
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polyMergeVert7.out" "polySurfaceShape1.i";
